...
# # Plot of COVID-19 growth curve in different countries
# data_transposed.plot(y = ['Australia', 'China', 'US', 'Italy'], use_index = True, figsize = (8,8), marker = '*')


# Read in the world map shapefile 
world = gpd.read_file('D:\\map_pics\\World_Map.shp')

# Replacing names in geopandas dataframe with names in the csv file
...
for dates in merge.columns.to_list()[69:71]:
